...
import { assignCourseAction } from '../users/actions'

export type OwnerChip = { id: string; name: string; via: string }
export type StaffOption = { id: string; name: string }

/**
 * Owner cell with click-to-assign: clicking "No owner" (or the +) opens an
 * inline picker that assigns a course owner on the spot.
 */
